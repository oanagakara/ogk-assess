...
urlpatterns = [
    ...
    path("attempt/<str:code>/review/", views.attempt_review_info, name="attempt_review_info"),
    path("attempt/<str:code>/review/<int:n>/", views.attempt_review_question, name="attempt_review_question"),
    path("attempt/<str:code>/review/submit/", views.attempt_review_submit, name="attempt_review_submit"),
